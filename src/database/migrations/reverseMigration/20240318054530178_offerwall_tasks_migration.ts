...
export async function up(db: Kysely<any>): Promise<void> {
  await db.schema
    ...
    .addColumn("description", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("instructions", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("image", sql<any>`varchar(255)`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    ...
    .addColumn("countries", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("devices", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("platforms", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("conversion_rate", "text", (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    ...
    .addColumn("offer_type", sql<any>`varchar(255)`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("network_categories", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
    .addColumn("network_goals", sql<any>`longtext`, (col) =>
      col.defaultTo(sql<any>`NULL`)
    )
